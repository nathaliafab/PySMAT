...
classDiagram
    ...
    class TestSuitesExecution {
        +execute_test_suites(TestSuite[] suite, ScenarioFiles jars) TestCaseExecutionInMergeScenario[]
        +execute_test_suites_with_coverage(TestSuite[] suite, ScenarioFiles jars, String[] classes) TestCaseExecutionInMergeScenario[]
    }
