...
class SMAT:
  ...
  def run_tool_for_semmantic_conflict_detection(self, scenario: MergeScenarioUnderAnalysis) -> None:
    ...
    executions = self._test_suites_execution.execute_test_suites(test_suites, scenario.scenario_files)
  ...
  def _generate_test_suites_for_scenario(self, scenario: MergeScenarioUnderAnalysis) -> List[TestSuite]:
      ...
      suites_left = self._test_suite_generation.generate_test_suites(scenario, scenario.scenario_files.left, use_determinism)
      suites_right = self._test_suite_generation.generate_test_suites(scenario, scenario.scenario_files.right, use_determinism)
